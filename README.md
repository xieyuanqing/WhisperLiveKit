...
- 如果你只需要最原始的浏览器体验，`wlk` 自带一个简易网页；如果你需要稳定运维，建议使用控制平面 + 独立控制台
